            ...
            do {
                ...
                if($posStart !== false && $posStart == 0){
                    ...
                    if($posEnd !== false && $posEnd == 0){
                        ...
                        //$this->properties[] = new myProperty(null, $iterator, $seek);
                    }
                }
...
//                    $prend =
//$this->properties[] = new myProperty("AHOJ");
                        $this->properties[] = new myProperty(null, $this->getMaster(), $line, $end);
...
//        dbg_error_log( 'vComponent', "::CollectParameterValues(%s) : Found '%s'", $parameter_name, $also);
        ...
        function AddProperty( $new_property, $value = null, $parameters = null ) {
            ...
            if ( isset($value) && gettype($new_property) == 'string' ) {
                $new_prop = new myProperty('', $this->getMaster());
...
//      dbg_error_log('vComponent'," Adding new property '%s'", $new_prop->Render() );
            ...
            else if ( $new_property instanceof myProperty ) {
        ...
        function InternalRender($restricted_properties = null, $force_rendering = false){
            ...
            if($unroledComponents){
                ...
                foreach($this->components as $component){
                    //$component->explode();
                    //$count++;
                    $rendered .= $component->InternalRender();
                    //$component->close();
